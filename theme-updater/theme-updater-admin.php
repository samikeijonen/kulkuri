...
class EDD_Theme_Updater_Admin {
					...
					<tbody>
						...
						<tr valign="top">
							...
							<td>
								...
								if ( 'valid' == $status ) { ?>
									<input type="submit" class="button-secondary" name="<?php echo $this->theme_slug; ?>_license_deactivate" value="<?php esc_attr_e( 'Deactivate License', 'kulkuri' ); ?>"/>
								<?php } else { ?>
									<input type="submit" class="button-secondary" name="<?php echo $this->theme_slug; ?>_license_activate" value="<?php esc_attr_e( 'Activate License', 'kulkuri' ); ?>"/>
								<?php }
								?>
							</td>
						</tr>
	...
	function check_license() {
		...
		if ( isset( $license_data->expires ) ) {
			...
			$renew_link = '<a href="' . esc_url( $this->remote_api_url) . '">' . __( 'Renew?', 'kulkuri' ) . '</a>';
		}
		...
		if ( $license_data->license == 'valid' ) {
			...
			if ( $site_count && $license_limit ) {
				$message .= sprintf( __( 'You have %1$s / %2$s sites activated.', 'kulkuri' ), $site_count, $license_limit );
			}
