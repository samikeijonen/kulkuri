 ...
 * @return void
 */
function kulkuri_custom_background_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'default-image'    => '',
			'wp-head-callback' => 'kulkuri_custom_background_callback',
		)
	);
}
add_action( 'after_setup_theme', 'kulkuri_custom_background_setup', 15 );
 ...
 * @return void
 */
function kulkuri_custom_background_callback() {
