...
class Kulkuri_Theme_Updater_Admin {
	...
	public function init( $args ) {
		...
		add_action( 'update_option_kulkuri_license_key', array( $this, 'activate_license' ), 10, 2 );
	...
	function updater() {
		...
		new Kulkuri_Theme_Updater( array(
	...
	function license_page() {
		...
		if ( ! $license ) {
			...
			if ( ! get_transient( 'kulkuri_license_message', false ) ) {
				set_transient( 'kulkuri_license_message', $this->check_license(), ( 60 * 60 * 24 ) );
			}
